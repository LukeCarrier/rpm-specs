...
BuildRequires: bzip2-devel, gcc, gmp-devel, httpd-devel, krb5-devel, libjpeg-devel, libxml2-devel, libXpm-devel, make, libmcrypt-devel, mysql-devel, openssl-devel, pcre-devel, t1lib-devel
