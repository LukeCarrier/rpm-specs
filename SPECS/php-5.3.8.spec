...
BuildRequires: bzip2-devel, gcc, gmp-devel, httpd-devel, krb5-devel, libjpeg-turbo-devel, libxml2-devel, libXpm-devel, make, openssl-devel, pcre-devel, t1lib-devel
